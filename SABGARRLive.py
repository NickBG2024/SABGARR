...
def show_series_stats_page(series_choice):    
    ...
    if series_choice == "2026 - Series 4":
        ...
        with tabs[0]:
            ...
            st.markdown("**The 2026 Round Robin leagues concludes with Series 4, taking place 14 Sept 2026 - 6 Dec 2026, with over 100 players competing across ten league groups (A-G and 4 Guppy Groups). The top five leagues play matches to 11 points. The next three leagues, E, F and G play to 9 points. There are also four 'Guppy' groups for new players.**")
    ...
    if series_choice == "2026 - Series 3":
        ...
        with tabs[0]:
            st.header("Overview")
            pdf_url = "https://www.sabga.co.za/wp-content/uploads/2026/03/SABGA-Round-Robin-Online-Leagues-2026-rules-etc-v6.1.pdf"
            st.markdown("**The 2026 Round Robin leagues continues with Series 3, taking place 24 June 2026 - 13 Sept 2026, with 102 players competing across ten league groups (A-G and 4 Guppy Groups). The top five leagues play matches to 11 points. The next three leagues, E, F and G play to 9 points. There are also four 'Guppy' groups for new players.**")
            st.markdown(f"All league information (rules, etc) can be found here: [SABGA Round Robin Leagues 2026 - rules etc v6.1.pdf]({pdf_url})", unsafe_allow_html=True)
            st.write("This tab offers an overview: a table showing all players, recent results and remaining fixtures.")
    ...
    #2026 - SERIES 2 LEAGUE DATA DISPLAY       
    if series_choice == "2026 - Series 2":
