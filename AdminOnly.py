...
if st.button("🔄 Run B-League S1 2026 H2H Debug Test"):
...
st.sidebar.header("Current series: RR S4 2026 (id=13)")
#st.sidebar.metric("Series data - players","10","1")
st.sidebar.metric("Series data - matches",metric_value, "1")
