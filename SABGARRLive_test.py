...
show_top10_match_PRs = st.sidebar.checkbox("Top 10 - Lowest PRs (single match)")
show_top10_9matchseries_PRs = st.sidebar.checkbox("Top 10 - Lowest Series PRs (9 match)")
show_top10_unluckiest_wins = st.sidebar.checkbox("Top 10 - Unluckiest wins")
show_top10_most_points_in_a_series = st.sidebar.checkbox("Top 10 - Most points in a Series")
