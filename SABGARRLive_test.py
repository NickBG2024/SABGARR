...
def show_series_stats_page(series_choice):
    ...
    if series_choice == "2025 - Series 4":
        ...
        # Calculate days left until end of series 3 (31 Dec, 2025)
        #today = date.today()
        ...
        col2.write("Deadline: 31 Dec 2025")
        ...
        with tabs[0]:
            ...
            st.markdown("**The 2025 Round Robin leagues continues with Series 4, taking place 2 Oct 2025 - 31 Dec 2025, with 74 players competing in eight leagues (A-G). The top five leagues play matches to 11 points. The next two leagues, E and F, play to 9 points. There are also two 'Guppy' groups for new players.**")
    ...
    elif series_choice == "2025 - Series 3":    
